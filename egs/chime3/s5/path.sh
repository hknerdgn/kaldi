export KALDI_ROOT=/data/erdogan/prog/kaldi
...
# For CNTK.
export LD_LIBRARY_PATH=/usr/local/acml5.3.0/gfortran64/lib/:$LD_LIBRARY_PATH
export LD_LIBRARY_PATH=/usr/local/cuda/lib64:$LD_LIBRARY_PATH
export LD_LIBRARY_PATH=/data/erdogan/prog/cntk/bin/:$LD_LIBRARY_PATH
export LD_LIBRARY_PATH=/data/erdogan/prog/kaldi/src/lib/:$LD_LIBRARY_PATH
export PATH=/data/erdogan/prog/cntk/bin:$PATH
