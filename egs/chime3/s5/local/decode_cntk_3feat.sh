...
[[ -d $sdatafeat3 && $datafeat3/feats.scp -ot $sdatafeat3 ]] || split_data.sh $datafeat3 $nj || exit 1;
...
for f in $sdatafeat1/1/feats.scp $sdatafeat2/1/feats.scp $sdatafeat3/1/feats.scp $model $graphdir/HCLG.fst; do
...
inputfeats3="$sdatafeat3/JOB/cntkOutput.scp"
if [ ! -f $sdatafeat3/JOB/sls.scp ]; then
    $cmd JOB=1:$nj $dir/log/make_input.JOB.log \
        echo scp:$sdatafeat3/JOB/feats.scp \> $inputfeats3
fi

# Run the decoding in the queue
if [ $stage -le 0 ]; then
  $cmd $parallel_opts JOB=1:$nj $dir/log/decode.JOB.log \
    $cnstring inputCounts=$inputCounts inputFeats1=$inputfeats1 inputFeats2=$inputfeats2 inputFeats3=$inputfeats3 numCPUthreads=${num_threads} \| \
