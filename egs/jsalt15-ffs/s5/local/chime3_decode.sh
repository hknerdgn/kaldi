...
if [ $# != 5 ]; then
   echo "Usage: chime3_decode.sh [options]  <dnn-dir> <graph-dir> <data-dir> <decode-dir> <acwt>"
...
local/score_chime3.sh $scoring_opts --cmd "$decode_cmd" $data_dir $graph_dir $decode_dir
